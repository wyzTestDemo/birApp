package gx.com.common.MyToolBar;
...
public class EnjoyshopToolBar extends Toolbar {
    ...
    public EnjoyshopToolBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            boolean isShowWeak = a.getBoolean(R.styleable.EnjoyshopToolBar_isShowWeakIcon, false);
            if(!isShowWeak){
                weakButton.setVisibility(GONE);
            }
    ...
    private void initView() {
        ...
        if (mView == null) {
            ...
            weakButton = (ImageButton) mView.findViewById(R.id.toolbar_weakButton);
    ...
    /*设置扫描按钮事件*/
    public void setWeakButtonIcon(OnClickListener listener){
        weakButton.setOnClickListener(listener);
    }
